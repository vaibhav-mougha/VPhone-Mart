    ...
    <div class="row">
      <div class="col-6 col-md-2 mb-3">
        ...
        <ul class="nav flex-column">
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Application</a></li>
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Documentation</a></li>
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Systems</a></li>
      ...
      <div class="col-6 col-md-2 mb-3">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Premium Plans</a></li>
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Affiliate Program</a></li>
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Promotions</a></li>
      ...
      <div class="col-6 col-md-2 mb-3">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Partnerships</a></li>
